...
export default function HeroBanner({ products = [] }: Props) {
  ...
  return (
    <section className="relative bg-[#fbfbfd] overflow-hidden flex flex-col">
      ...
      <div className="flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8 pt-16 pb-6 md:pt-20 md:pb-8">
        ...
        <ScrollReveal animation="fade-up" delay={150} duration={900}>
          <p className="apple-subheadline max-w-2xl mx-auto mt-6">
            {t('subtitle')}
          </p>
        </ScrollReveal>
