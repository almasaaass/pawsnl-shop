...
const bundles: Bundle[] = [
  {
    name: 'Honden Starterspakket',
    slug: 'honden-starterspakket',
    emoji: '🐕',
    description: 'Alles wat je nodig hebt voor een gelukkige hond. Van speelgoed tot verzorging.',
    category: 'honden',
    productSlugs: [],
    discountPercent: 15,
  },
  {
    name: 'Katten Verwenpakket',
    slug: 'katten-verwenpakket',
    emoji: '🐈',
    description: 'Verwen je kat met dit luxe pakket vol speelgoed en comfort.',
    category: 'katten',
    productSlugs: [],
    discountPercent: 15,
  },
  {
    name: 'Vogel Essentials',
    slug: 'vogel-essentials',
    emoji: '🐦',
    description: 'De basis voor een gelukkige vogel: van speelgoed tot verzorging.',
    category: 'vogels',
    productSlugs: [],
    discountPercent: 10,
  },
  {
    name: 'Knaagdier Gelukspakket',
    slug: 'knaagdier-gelukspakket',
    emoji: '🐹',
    description: 'Maak je knaagdier blij met dit uitgebreide pakket.',
    ...
    <div>
      ...
      <section className="bg-gradient-to-br from-orange-50 via-white to-amber-50 py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Samengestelde pakketten voor jouw huisdier. Meer waarde, minder betalen.
          </p>
        </div>
      </section>
      ...
      <section className="py-6 px-4 bg-white border-b border-gray-100">
        <div className="max-w-4xl mx-auto flex items-center justify-center gap-3">
          ...
          <span className="text-sm font-semibold text-emerald-800">100% Blij-Dier Garantie op alle bundels</span>
            ...
            <div key={bundle.slug} className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="p-6 md:p-8">
                <p className="text-xs text-gray-400 uppercase tracking-wider font-semibold mb-4">
                  In dit pakket ({bundle.products.length} producten)
                </p>
