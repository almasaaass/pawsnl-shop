...
import { LayoutDashboard, Package, ShoppingCart, Users, LogOut, Music, BarChart2, Download, TrendingUp, Shield, Camera } from 'lucide-react'
...
const navItems = [
  ...
  { href: '/admin/quality', label: 'Quality Check', icon: Shield },
  ...
  { href: '/admin/foto-studio', label: 'Foto Studio', icon: Camera },
]
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside className="w-64 bg-gray-900 text-white flex flex-col fixed inset-y-0 left-0 z-50">
        ...
        <div className="p-6 border-b border-gray-700">
          <Link href="/admin" className="flex items-center gap-2">
            ...
            <div>
              ...
              <span className="block text-xs text-gray-400">Admin paneel</span>
            </div>
          </Link>
        </div>
        ...
        <div className="p-4 border-t border-gray-700">
          ...
          >
            <span className="text-sm">← Naar de webshop</span>
          </Link>
        </div>
      </aside>
